...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/estiloecommerprincipal.css">
</head>
<body>
	<header>
		<div class="logo-place"><a href="index.php"><img src="assets/Logo-coco4.2.1.png"></a></div>
	...
	<div class="main-content">
		<div class="content-page">
			...
			<div class="p-line"><div>Banco:</div>Banesco</div>
			<div class="p-line"><div>N° de Cuenta:</div>999-99999999-999</div>
			<div class="p-line"><div>Representantes:</div>victor rosario y jorge rodriquez</div>
			<p><b>NOTA:</b> Para confirmar la compra debe realizar el deposito por el monto total, y enviar el comprobante al siguiente correo easycatchpizza@gmail.com.com o al número de whatsapp 999 666 333</p>
		</div>
	</div>
