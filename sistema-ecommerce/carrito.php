<?php
	session_start();
	if (!isset($_SESSION['codusu'])) { /*le estamos dciendo que si no existe una sesseion de usuario que nos devuelva al index*/
...
<body>
	...
	<div class="main-content">
		<div class="content-page">
			...
			<button onclick="procesar_compra()"  class="boton-carrito-de-compras" style="margin-top: 5px;">Procesar compra</button>
		</div>
	</div>
	<script type="text/javascript">
		$(document).ready(function(){
			$.ajax({
				url:'servicios/pedido/get_porprocesar.php', /*aqui esta la logica para que parescan las imagenes de los pedidos*/
				type:'POST',
				data:{},
