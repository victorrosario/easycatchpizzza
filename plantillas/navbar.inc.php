...
<nav class="navbar navbar-default navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <!--LOGO DE LA PAGINA-->
          <a class="navbar-brand" href="<?php echo SERVIDOR; ?>"><img src="./img/logo-coco4.2.1.png" alt=""></a>
          <!--fin del logo de pa pagina-->
        </div>
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li><a href="<?php echo RUTA_TIENDA_ONLINE; ?>"> <span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> tienda online</a></li>
